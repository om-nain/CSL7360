...
class EssentialMatrixTransform(object):
  ...
  def estimate(self, src, dst):
    # RANSAC expects estimate() to return True/False, not explode.
    if src.shape != dst.shape:
      return False
    # Need at least 8 points for the 8-point algorithm
    if src.shape[0] < 8:
      return False
    ...
    # Enforce the internal constraint: rank-2 essential matrix
